        ...
        <div class="col d-flex justify-content-center pb-3">
            <form action="pago" method="POST">
                <div class="form-group">
                    ...
                    <input required type="text" class="form-control" id="servicio" name="servicio" placeholder="Por ej. Metrogas">
                </div>
                <div class="form-group">
                    <label for="referencia">Numero de referencia</label>
                    <input required  type="number" class="form-control" id="referencia" name="referencia" placeholder="Numero de referencia">
                </div>
                <div class="form-group">
                    <label for="importe">Importe</label>
                    <input required  type="number" class="form-control" id="importe" name="importe" placeholder="Monto a pagar ">
                </div>
